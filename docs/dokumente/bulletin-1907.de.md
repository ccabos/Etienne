...
![Bulletin 1907 - Seite über Etienne Cabos](../images/bulletin-1907.jpg){ loading=lazy }
...
| **Artikel** | "Une correspondance berlinoise de fils de réfugiés", S. 142-144 |
...
!!! warning "Neue Erkenntnisse über Etienne Cabos"
...
Die Passage stammt aus dem Artikel **„Une correspondance berlinoise de fils de réfugiés"** (Bulletin 1907, S. 142-144). Der Text berichtet über französische und gaskognische Deserteure, die in preußische Regimenter aufgenommen wurden. Das französische Original lautet:
...
*Einer dieser Deserteure, **Etienne Cabos**, dessen älterer Bruder wegen eines mir unbekannten Vergehens in Caussade **in effigie (im Bildnis) hingerichtet** worden war, war 1792 von der französischen Besatzungsmacht aus Holland vertrieben worden; auf seiner überstürzten Flucht hatte er seine Habseligkeiten verloren. Dieser Abenteurer wurde nacheinander Friseur, Zahnarzt, Parfümeur und trat in das Regiment de Brévern ein; er erhielt zahlreiche Stockschläge, um die preußische Exerzierkunst zu erlernen. Seine Frau, die sich die Erbschaft eines Offiziers **erschlichen** hatte, war 1802 zusammen mit ihrem Mann und ihren Kindern aufs Hospital angewiesen.*

!!! danger "Wichtige Korrektur: 'effigié' - nicht real hingerichtet!"
    Das französische Original sagt **nicht**, dass der Bruder hingerichtet wurde. **"Effigié"** bedeutet: **in effigie hingerichtet** - die Strafe wurde in Abwesenheit an einem Bildnis oder einer Strohpuppe vollstreckt. Diese Praxis des Ancien Régime galt Verurteilten, die **geflohen** waren und in Abwesenheit (par contumace) verurteilt wurden. Der ältere Bruder wurde also nicht getötet - **er hatte Caussade verlassen und entzog sich der Justiz**. Frühere Übersetzungen dieser Stelle als "hingerichtet" führten in die Irre.
...
| **Bruder "effigié"** | 🔄 Neu gelesen | Der Bruder wurde **in effigie** hingerichtet, d.h. **in Abwesenheit verurteilt - er war geflohen und lebte möglicherweise weiter**. Weder **[Jean](hochzeit-jean-1760.md)** (†1796 in Caussade) noch **[Pierre](taufe-pierre-1740.md)** (1740, jünger als Etienne) passen als Verurteilte; es bleibt also ein **weiterer, älterer Bruder** wahrscheinlich - aber gesucht wird nun kein Toter, sondern ein **Flüchtling** |
...
| **Frau "erschlich" Offizierserbe** | ❓ Nicht verifiziert | Keine andere Quelle erwähnt dies. Das Original ("après avoir capté la succession") unterstellt eine **Erbschleicherei** - eine boshafte Note des Briefschreibers, die zeigt, wie abschätzig in der Kolonie über die Familie geredet wurde |
...
!!! info "Warum kannten die Palmiés die Familie Cabos?"
    Die Verbindung ist dokumentiert: **Agnes Louise Amelie Palmié, geb. Rauch**, war 1793 [Taufpatin von Etiennes Sohn Charles Emmanuel](taufe-berlin-1793.md). Die Familien kannten sich also persönlich - das erklärt, warum Cabos in der Palmié-Korrespondenz so detailliert (wenn auch nicht immer korrekt und mit spürbarer Herablassung: "cet aventurier", die Frau als Erbschleicherin) beschrieben wird.

    Der Artikel verrät auch mehr über die Briefpartner: **J.-M. Palmié** war Weinhändler in Berlin; sein Onkel **Antoine Palmié** gehörte zu den ersten Réfugiés der Stadt und hatte dort eine Apotheke gegründet. **Thomas Thuet** - aus jener Familie Thuet, die 1760 beim [Ehevertrag von Etiennes Bruder Jean](hochzeit-jean-1760.md) in Caussade als Verwandtschaft der Braut auftritt - war Palmiés **Cousin** und erkundigte sich 1784 brieflich, ob sein Bruder Jean Thuet in Deutschland eine Apotheke eröffnen solle. Die Korrespondenz verband also nachweislich Berlin mit dem engsten Umfeld der Familie Cabos in Caussade.
...
Die Lesart **"effigié"** (in effigie hingerichtet, siehe oben) passt bemerkenswert gut zu den Ereignissen von 1761/62: Nach dem Marktaufruhr bei Rochettes Verhaftung wurden die Unterstützer verfolgt - die Rädelsführer, die man fasste, kamen auf die **Galeeren**; wer **geflohen** war, wurde in Abwesenheit (par contumace) verurteilt und **in effigie** hingerichtet. Ein älterer Cabos-Bruder, der am Aufruhr beteiligt war und rechtzeitig floh, würde exakt dem Satz des Bulletins entsprechen: *"effigié à Caussade pour je ne sais quel méfait"*.

Daraus ergeben sich mehrere Deutungen:

1. **Geflohener Bruder** (plausibelste Lesart): Ein älterer Bruder wurde - etwa nach dem Aufruhr von 1761 oder wegen anderer Désert-Delikte - in Abwesenheit verurteilt und in effigie hingerichtet. Er lebte danach möglicherweise irgendwo im Refuge weiter. Denkbar wäre sogar, dass er zu jener "Familie in Deutschland" gehörte, die die Cabos [1792 zu sich einlud](unterhaltsvertrag-1792.md) - das bleibt aber reine Spekulation
2. **Verwechslung**: Der Autor von 1907 könnte Informationen über andere Verurteilte der Region mit der Familie Cabos vermischt haben
3. **Fluchtgrund für Etienne**: Die Verfolgungswelle könnte auch Etienne selbst zur Auswanderung bewogen haben - ein in effigie hingerichteter Bruder hätte die Familie als "vorbestraft" gebrandmarkt
